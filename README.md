...
[FabGL](https://github.com/fdivitto/FabGL) 配下で NEC PC-8001 の画面表示を行う VGA ディスプレイドライバの単体テスト用プログラムです。
...
この単体テストプログラムを動作させるためには [FabGL](https://github.com/fdivitto/FabGL) のインストールと microSD カードが必要です。microSD カードには以下の構造でフォントファイルを配置します。
